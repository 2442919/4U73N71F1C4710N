...
printf "$header" "[Date]$roman_dom.$roman_month.$roman_year."
printf "[Time]$roman_h:$roman_m:$roman_s"
#SetPasswd:
syspasswd=$roman_dom$roman_month$roman_year$roman_h$roman_m$roman_s
#PrintOutput
echo " "
echo " "
